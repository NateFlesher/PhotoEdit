...
@interface PhotoEditView () <UIScrollViewDelegate, CropViewDelegate>
             ...
             maxRotationAngle:(CGFloat)maxRotationAngle
{
    if (self = [super init]) {
        ...
        [_resetBtn setTitle:NSLocalizedStringFromTable(@"Reset", @"PhotoEdit", nil) forState:UIControlStateNormal];
