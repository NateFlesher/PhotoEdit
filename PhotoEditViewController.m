...
#import "UIColor+Edit.h"
#import <AssetsLibrary/AssetsLibrary.h>

@interface PhotoEditViewController ()

@property (strong, nonatomic) PhotoEditView *photoView;
...
- (void)viewDidLoad
{
    ...
    self.view.backgroundColor = [UIColor photoEditCanvasBackgroundColor];
...
- (void)setupSubviews
{
    self.photoView = [[PhotoEditView alloc] initWithFrame:self.view.bounds image:self.image maxRotationAngle:self.maxRotationAngle];
    ...
    [cancelBtn setTitle:NSLocalizedStringFromTable(@"Cancel", @"PhotoEdit", nil) forState:UIControlStateNormal];
    ...
    [cropBtn setTitle:NSLocalizedStringFromTable(@"Done", @"PhotoEdit", nil) forState:UIControlStateNormal];
...
- (void)saveBtnTapped
{
    ...
    [self.delegate photoEditController:self didFinishWithCroppedImage:image];
}
